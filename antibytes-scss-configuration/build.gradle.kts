...
val pluginId = "${LibraryConfig.group}.configuration.kmp.scss"
...
gradlePlugin {
    plugins.create(pluginId) {
        id = pluginId
        displayName = "SCSS Configuration Plugin for Antibytes projects."
        implementationClass = "tech.antibytes.gradle.configuration.AntibytesScssConfiguration"
        description = "SCSS Configuration Plugin for Antibytes projects."
    }
}
