...
abstract class AntiBytesIntegrationTestConfigurationTask : AntiBytesRuntimeConfigurationTask() {
    override val fileName: String = "IntegrationTestConfig"
    ...
    private fun determinePath(): String {
        return if (project.isKmp()) {
            "${determineSourceSet()}IntegrationTest"
        } else {
            "integrationTest"
        }
    }
