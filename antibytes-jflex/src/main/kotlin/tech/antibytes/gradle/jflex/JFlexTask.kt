...
import tech.antibytes.gradle.jflex.JFlexTaskError.Companion.MISSING_FLEX_FILE
import tech.antibytes.gradle.jflex.JFlexTaskError.Companion.MISSING_OUTPUT_DIRECTORY
import java.io.File
import java.nio.charset.Charset
import kotlin.jvm.Throws

@CacheableTask
abstract class JFlexTask : JFlexApiContract.JflexTask, DefaultTask() {
    init {
