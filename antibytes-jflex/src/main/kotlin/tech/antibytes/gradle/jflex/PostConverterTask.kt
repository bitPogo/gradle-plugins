...
import tech.antibytes.gradle.jflex.PostConverterTaskError.Companion.MISSING_TARGET_FILE

abstract class PostConverterTask : DefaultTask(), JFlexApiContract.PostConverterTask {
    init {
